...
<td bgcolor=#ffffff align=left><%=adminname%>&nbsp;&nbsp;你好!&nbsp;&nbsp;请选择实验室：
<%
set rs=Server.CreateObject("ADODB.Recordset")
'sqlstr="select * from lab where lab_id<22"
sqlstr="select distinct 实验室地点 from kc"
%>
...
Do While Not Rs.EOF 
Response.Write "<option value='labkc.asp?teacher="& rs("实验室地点") &"'>" &  rs("实验室地点") & "</option>"
Rs.MoveNext
Loop 
rs.close
set rs=nothing%>
...
<td bgcolor=#ffffff>
<%
sqlstr="select * from kc where 实验室地点='"&request("teacher")&"'"
